...
const MESSAGES = [
  ...
  { from: 'Czeka', text: 'Drága Zsolt, WandOcska! Sokan vagyunk, akik nem tökéletesek. Neked is vannak csetléseid, botlásaid, nekem is. De! Emberségből az egyik legjobbra vizsgáztál a 2-3.000 ember közül, akiket ismerek. Ha kell, akkor vagy! Karácsonykor senki ne vacsorázzon egyedül… Ez a mondatod pl. örökre bevésődött. Meg szépen öregszel, mert még mindig puha a hajad 😊 (nekem már nincs) Boldog Szülinapot! Czeka' },
];
