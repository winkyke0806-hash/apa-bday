...
export const TRACKS = {
  ...
  driftking: {
    id: 'driftking',
    name: 'Drift Paradicsom',
    icon: '🔥',
    type: 'outdoor',
    description: 'Széles kanyarok, hosszú ívek — driftelj végig!',
    color: '#ec4899',
    data: [
      // Big sweeping oval with long curves — perfect for drifting
      [0.50,0.10],[0.40,0.10],[0.30,0.11],[0.22,0.14],[0.16,0.20],
      [0.12,0.28],[0.10,0.38],[0.10,0.50],[0.12,0.62],[0.16,0.72],
      [0.22,0.80],[0.30,0.85],[0.40,0.88],[0.50,0.90],[0.60,0.88],
      [0.70,0.85],[0.78,0.80],[0.84,0.72],[0.88,0.62],[0.90,0.50],
      [0.88,0.38],[0.84,0.28],[0.78,0.20],[0.70,0.14],[0.60,0.10],
    ],
    decorations: [],
  },
};
