...
export const TRACKS = {
  ...
  figure8: {
    ...
    icon: '♾️',
    type: 'indoor',
    description: 'Nyolcas alakú pálya — figyelj a kereszteződésnél!',
    color: '#ec4899',
    data: [
      [0.50,0.20],[0.42,0.18],[0.34,0.20],[0.28,0.26],[0.24,0.34],[0.24,0.42],
      [0.28,0.48],[0.34,0.52],[0.42,0.50],[0.50,0.50],
      [0.58,0.52],[0.66,0.56],[0.72,0.62],[0.76,0.70],[0.76,0.78],
      [0.72,0.84],[0.66,0.86],[0.58,0.84],[0.50,0.80],
      [0.42,0.78],[0.34,0.82],[0.28,0.78],[0.24,0.70],[0.24,0.62],
      [0.28,0.56],[0.34,0.52],[0.42,0.50],[0.50,0.50],
      [0.58,0.48],[0.66,0.44],[0.72,0.38],[0.76,0.30],[0.76,0.24],
      [0.72,0.20],[0.66,0.18],[0.58,0.20],
    ],
    decorations: [],
  },
};
